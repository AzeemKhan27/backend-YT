...
router.route("/c/:username").get(verifyJWT,getUserChannelProfile) //getUserChannelProfile
router.route("/watch-history").get(verifyJWT,getWatchHistory) //getUserChannelProfile
